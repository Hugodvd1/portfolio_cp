...
{
    #[Route('/', name: 'app_admin_projects_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_admin_projects_new', methods: ['GET', 'POST'])]
    public function new(Request $request, ProjectsRepository $projectsRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_projects_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_admin_projects_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_admin_projects_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_admin_projects_delete', methods: ['POST'])]
